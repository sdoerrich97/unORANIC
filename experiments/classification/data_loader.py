...
@description:
Data Loader of the simultaneous anatomy & image characteristics classification experiment.
...
class MEDMNIST(Dataset):
    ...
    def __getitem__(self, index: int):
        ...
        sample_name = f"{index}"
        sample_orig, label_content = self.samples[index], self.labels[index]
        ...
        # Return the samples
        return sample_orig, sample, label_content, np.array([label_attribute]), sample_name
