...
def main(data_flag, data_path, shots_per_class, channel_dim, output_root, num_epochs, gpu_ids, batch_size, download, model_flag, resize, as_rgb, model_path,
    ...
    data_loader = DataLoaderCustom(data_flag, data_path, '0', shots_per_class, (28, 28, channel_dim), batch_size)
    ...
    if model_flag == 'resnet18':
        ...
        model = resnet18(weights=ResNet18_Weights.IMAGENET1K_V1)  # Load pre-trained ResNet18 model
        ...
        model = resnet50(weights=ResNet50_Weights.IMAGENET1K_V1)  # Load pre-trained ResNet18 model
        model.fc = nn.Linear(model.fc.in_features, n_classes)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_root',
                        default='./output/imagenetRes18_lastlayer',
    ...
    main(data_flag, data_path, shots_per_class, channel_dim, output_root, num_epochs, gpu_ids, batch_size, download, model_flag, resize, as_rgb, model_path, run)